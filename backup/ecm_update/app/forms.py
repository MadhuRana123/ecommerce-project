...
class LoginForm(AuthenticationForm):
    ...
    password = forms.CharField(label=_("password", widget=forms.PasswordInput(attrs={'autofocus':True,'class':'form-control','label': 'password','placeholder': 'password'})))
...
class MyPasswordChangeForm(PasswordChangeForm):
    ...
    new_password = forms.CharField(label =_("New Password"),strip=False,widget=forms.PasswordInput
    ...
    (attrs={'autocomplete':'Confirm New Password',
    'autofocus':True,'class':'form-control'}))
